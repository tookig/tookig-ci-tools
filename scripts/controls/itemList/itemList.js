...
(function (controls) {
  ...
  function create() {
    this.element = $('<table></table>').addClass('item-list-control'); // List items header

    this.header(); // List items container

    $('<tbody></tbody>').addClass('item-list-items').appendTo(this.element); // Footer

    this.footer(); // Load content
  ...
  function header() {
    ...
    $('<th></th>').addClass('not-sortable item-list-action-cell').appendTo(tr); // Header clicks
