...
(function (controls) {
  ...
  function controlList(args) {
    ...
    var control = Object.assign(controls.control(iargs), controlListPrototype); // Init DOM objects

    create.call(control); // Create an internal collection that keeps track of the objects currently
    ...
    iargs.collection.register('remove', checkObjectRemove.bind(control)); // Return
  ...
  function checkObject(obj) {
    ...
    }.bind(this)); // Check if to add, remove or update list
