...
;(function (formatters) {
   ...
   */
  function input (item) {
    const element = $('<input></input>').attr('type', 'text').val(item)
    window.setTimeout(function () {
      element.spectrum({
        ...
        palette: [
          ['#00bfff', '#0080ff', '#0040ff', '#0000ff', '#4000ff'],
          ['#8000ff', '#bf00ff', '#ff00ff', '#ff00bf', '#ff0080'],
          ['#ff0040', '#ff0000', '#ff2000', '#ff4000', '#ff8000'],
          ['#ffbf00', '#ffff00', '#bfff00', '#80ff00', '#40ff00'],
