...
;(function (formatters) {
  ...
  function input () {
    ...
    return $('<div/>').append(
      $('<input></input>').attr('name', 'pwd1').attr('type', 'password')
    ).append(
      $('<input></input>').attr('name', 'pwd2').attr('type', 'password')
    )
  }
  ...
  function parse (element) {
    ...
    let pwd1 = element.find('input[name=\'pwd1\']').val()
    let pwd2 = element.find('input[name=\'pwd2\']').val()
